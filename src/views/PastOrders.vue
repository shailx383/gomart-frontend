<template>
	...
	<div class="overflow-x-auto relative shadow-md sm:rounded-lg">
		<h2 class="text-4xl font-sensserif text-black pt-10 text-center">
			Past Orders:
		</h2>
		...
		>
			<button
				type="button"
				@click="OrderPopUp()"
				class="focus:outline-none text-white bg-blue-700 hover:bg-blue-800 focus:ring-4 focus:ring-blue-300 font-medium rounded-lg text-sm px-5 mb-2 py-2.5 dark:bg-blue-600 dark:hover:bg-blue-700 dark:focus:ring-blue-900"
			>
