    ...
    <table class="w-full text-sm text-left text-gray-500 dark:text-gray-400">
        ...
        <tbody v-for="customer in customers" :key="customer.userId">
            <tr class="bg-white border-b dark:bg-gray-800 dark:border-gray-700">
                ...
                <td class="py-4 px-6">
                    <button type="button" @click="this.$router.push({id:customer.userId})" class="focus:outline-none text-white bg-purple-700 hover:bg-purple-800 focus:ring-4 focus:ring-purple-300 font-medium rounded-lg text-sm px-5 py-2.5 mb-2 dark:bg-purple-600 dark:hover:bg-purple-700 dark:focus:ring-purple-900" >View customer report</button>
                </td>
            </tr>
        </tbody>
    </table>
...
export default {
  ...
  methods: {
      async showReport(userId){
        this.$router.push(customer.userId)
      },
