<template>
	...
	<div class="overflow-x-auto relative shadow-md sm:rounded-lg">
		<h2
			class="font-sensserif text-4xl font-bold text-black pt-4 pb-4 text-center"
		>
			Products by Date
		</h2>
		...
		<div>
			<form class="flex items-center">
				<label for="simple-search text-center" class="sr-only"
					>Search</label
				>
				<div class="relative pl-6">
					<div
						class="absolute inset-y-0 left-0 flex items-center pl-9 pointer-events-none"
					>
						<svg
							aria-hidden="true"
					...
					<input
						...
						type="date"
						id="simple-search"
						class="bg-black-50 border border-black-300 text-black-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full pl-10 p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-black dark:focus:ring-blue-500 dark:focus:border-blue-500"
						placeholder="Date"
						required
					/>
				</div>
				<button
					@click.prevent="datesearch(date)"
					class="p-2.5 ml-4 text-sm font-medium text-black bg-black-700 rounded-lg border border-white-700 hover:bg-blue-800 focus:ring-4 focus:outline-none focus:ring-blue-300 dark:bg-blue-600 dark:hover:bg-blue-700 dark:focus:ring-blue-800"
				>
					<svg
						class="w-5 h-5"
						fill="none"
