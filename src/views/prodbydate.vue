      ...
      <div class="relative flex h-16 items-center justify-between">
        ...
        <div class="flex flex-1 items-center justify-center sm:items-stretch sm:justify-start">
          ...
          <div class="sm:ml-6 sm:block">
            <div class="flex space-x-4">
              <h2 class=" font-sansserif text-lg text-white pt-1 ml-3 mr-7"> Product By Date</h2>
        ...
        <div class="overflow-x-auto relative shadow-md sm:rounded-lg">
            ...
            <form class="flex items-center">   
              ...
              <button @click.prevent="datesearch(date)" class="p-2.5 ml-2 text-sm font-medium text-black bg-black-700 rounded-lg border border-white-700 hover:bg-blue-800 focus:ring-4 focus:outline-none focus:ring-blue-300 dark:bg-blue-600 dark:hover:bg-blue-700 dark:focus:ring-blue-800">
