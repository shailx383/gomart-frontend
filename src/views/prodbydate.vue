     ...
     <div class="relative flex h-16 items-center justify-between">
       ...
       <div class="absolute inset-y-0 right-0 flex items-center pr-2 sm:static sm:inset-auto sm:ml-6 sm:pr-0">
        ...
        <div class="overflow-x-auto relative shadow-md sm:rounded-lg">
            <h2 class="text-4xl font-extrabold dark:text-white pt-4 pb-4">Products by Date</h2>
            ...
            <form class="flex items-center">   
              ...
              <div class="relative">
                  ...
                  <input v-model="date" type="text" id="simple-search" class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full pl-10 p-2.5  dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500" placeholder="Date" required>
              </div>
              <button @click="datesearch(date)" class="p-2.5 ml-2 text-sm font-medium text-white bg-black-700 rounded-lg border border-white-700 hover:bg-blue-800 focus:ring-4 focus:outline-none focus:ring-blue-300 dark:bg-blue-600 dark:hover:bg-blue-700 dark:focus:ring-blue-800">
