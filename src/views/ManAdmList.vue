		...
		>
			...
			<tbody v-for="manager in currentManagers" :key="manager.userId">
				...
				>
					...
					<td class="py-4 px-6">
						<button
							@click="declineManager(manager.userId)"
							type="button"
							class="focus:outline-none text-white bg-red-700 hover:bg-red-800 focus:red-4 focus:ring-red-300 font-medium rounded-lg text-sm px-5 py-2.5 mb-2 dark:bg-red-600 dark:hover:bg-red-700 dark:focus:ring-red-900"
						>
							Remove
						</button>
					</td>
			...
			<tbody v-for="manager in pendingManagers" :key="manager.userId">
				...
				>
					...
					<td class="py-4 px-6">
						<button
							type="button"
							@click="approveManager(manager.userId)"
